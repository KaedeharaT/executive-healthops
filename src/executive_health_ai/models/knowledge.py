...
class KnowledgeUseRecord(Base):
    ...
    knowledge_document_id: Mapped[UUID | None] = mapped_column(ForeignKey("knowledge_documents.id"), nullable=True, index=True)
    ...
    external_chunk_ids: Mapped[list[str]] = mapped_column(JSON, nullable=False, default=list)
