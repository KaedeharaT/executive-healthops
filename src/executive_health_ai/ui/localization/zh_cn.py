...
PROVIDER={"apple_health":"苹果健康","mock_yuwell":"鱼跃血压（演示）","mock_oura":"Oura（演示）","mock_cgm":"动态血糖（演示）","glucose_meter_interface":"血糖仪","csv":"CSV 文件","excel":"Excel 文件","pdf":"PDF 健康报告","json":"JSON 接口"}
...
KNOWLEDGE_CATEGORY={"PATIENT_EDUCATION":"疾病与健康教育","MEDICATION":"药物","LAB_TEST":"检查与化验","DISEASE_CLASSIFICATION":"标准术语","INTERNAL_SOP":"内部SOP","RISK_RULE_EVIDENCE":"风险规则依据（仅参考）","CLINICAL_GUIDELINE":"医疗指南","TEXTBOOK_REFERENCE":"教材与参考书","CHRONIC_RISK":"慢病与风险","MANAGEMENT_PROGRAM":"管理方案","SERVICE_SOP":"服务SOP","DATA_DEVICE":"数据与设备","SAFETY_COMPLIANCE":"医疗边界与合规"}
